...
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'page.tpl', 1, false),array('modifier', 'default', 'page.tpl', 67, false),)), $this); ?>
...
.css">
			...
			<script src="js/formTools.js?v=<?php echo $this->_tpl_vars['NUM_VERSION']; ?>
"></script>
...
"></script>
		...
		<?php else: ?>
			<link rel="shortcut icon" type="image/x-icon" href="../favicon.ico" />
			<link rel="stylesheet" type="text/css" href="../css/GestionStyle.css?v=<?php echo $this->_tpl_vars['NUM_VERSION']; ?>
" />
			<link type="text/css" rel="stylesheet" href="../css/dhtmlgoodies_calendar.css?random=20051112" media="screen" />
			<link type="text/css" rel="stylesheet" href="../css/jquery.autocomplete.css" media="screen" />
			<link type="text/css" rel="stylesheet" href="../css/jquery.tooltip.css" media="screen" />
...
unset($_smarty_tpl_vars);
 ?>
        <?php if (! $this->_tpl_vars['bPublic']): ?>
            <script>
                masquer = <?php echo $this->_tpl_vars['masquer']; ?>
;
